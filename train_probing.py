...
# backbones
from ttmrpp_nc.model import ProbingLayer
from ttmrpp_nc.dataset_embs.data_manager import get_dataloader
...
from ttmrpp_nc.utils.transfer_utils import get_cls_config, print_model_params, single_query_evaluation
...
def main():
    ...
    model, sr, duration = load_ttmr_pp(save_dir) #pt model 로딩
    ...
    train_loader = get_dataloader(args=args, audio_embs=audio_embs, text_embs=None, split="TRAIN")
    val_loader = get_dataloader(args=args, audio_embs=audio_embs, text_embs=None, split="VALID")

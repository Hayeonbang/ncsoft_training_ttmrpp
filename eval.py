...
from ttmrpp_nc.utils.transfer_utils import get_cls_config, single_query_evaluation, get_evaluation
...
def main():
    ...
    with open(os.path.join(save_dir, f"result.json"), mode="w") as io:
